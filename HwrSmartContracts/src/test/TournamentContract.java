...
public class TournamentContract extends AbstractContract {
	...
	public void bett() {
		...
		if (adress.equals(ownerAdress) && !hasAllreadyPlayed(adress)) {
			...
			System.out.println("congratulations you have the permission to play!");
	...
	public void computeResults() {
		...
		if (count1 < count2) {
			System.out.println("the winner is the Player with the adress:" + partnerAdress + "!!!!!");
			printResults();
			System.out.println("the winner earns the following sum:" + totaldeposit);
	...
	public void printResults() {
		...
		System.out.println("-----------------");
		System.out.println();
		System.out.println(ownerAdress + count1);
		System.out.println(partnerAdress + count2);
	}

	@Override
	public void doContractsOperations() {
		this.computeNumbers();
		while (!(hasAllreadyPlayed(ownerAdress) && hasAllreadyPlayed(partnerAdress))) {
			this.bett();
		}
